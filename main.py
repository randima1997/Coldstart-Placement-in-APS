...
import torch
import getpass
from aps_dataset import APSSiameseDataset, EmbeddingNet, SiameseNet, contrastive_loss, train, validate
...
aps_df = pd.read_sql(query_aps, engine).set_index("dataset", drop= False)
...
torch.save(model.state_dict(), 'weights/APSSiamNet_weights_3.pth')
print("Model saved!")